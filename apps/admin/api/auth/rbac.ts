...
export const PLATFORM_FEATURES = [
  ...
  { key: 'notification_routing', label: 'Configurable Approval Routing', description: 'Admin-configurable "who approves/gets notified" chains (by department, branch, team, or reporting manager) for leave, attendance correction, WFH, and other approval-notification categories, instead of the default flat privilege-holder fan-out.' },
  { key: 'attendance_freeze', label: 'Attendance Freeze', description: 'HR can manually close a month\'s attendance; unresolved absences with no approved correction finalize as Loss of Pay from that point on, instead of never affecting pay.' },
